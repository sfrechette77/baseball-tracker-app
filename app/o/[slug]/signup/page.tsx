...
export default async function SignupPage({ params }: Props) {
  ...
  // Public signup runs before the visitor has an approved membership.
  // Use the server-only service client because tenant-table RLS would
  // block organization lookup for anonymous and new users.
